...
import img from "../../assets/images/about-page/about-img-3.jpg";
export default function TypoTypo() {
  return (
    <>
            ...
            <div className="row">
              <div className="col-lg-12">
                <article>
                  ...
                  <img src={img} alt="img" className="img-left img-fluid" />
                  <p>
                  ...
                  <p>
                    ...
                    <img src={img} alt="" className="img-fluid img-right" />
